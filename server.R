...
shinyServer(function(input, output, session) {
  ...
  ##LOG
  observeEvent(input$siteName, message(paste('input$siteName was changed to:', input$siteName, '\t')))
  observeEvent(input$siteDescription, message(paste('input$siteDescription was changed to:', input$siteDescription, '\t')))
  observeEvent(input$vegType, message(paste('input$vegType was changed to:', input$vegType, '\t')))
  observeEvent(input$roiName, message(paste('input$roiName was changed to:', input$roiName, '\t')))
  observeEvent(input$roiOwner, message(paste('input$roiOwner was changed to:', input$roiOwner, '\t')))
  observeEvent(input$roiColors, message(paste('input$roiColors was changed to:', input$roiColors, '\t')))
  
  observeEvent(input$back, message(paste('input$back was changed to:', input$back, '\t')))
  observeEvent(input$backplay, message(paste('input$backplay was changed to:', input$backplay, '\t')))
  observeEvent(input$forw, message(paste('input$forw was changed to:', input$forw, '\t')))
  observeEvent(input$play, message(paste('input$play was changed to:', input$play, '\t')))
  observeEvent(input$pause, message(paste('input$pause was changed to:', input$pause, '\t')))
  
  observeEvent(input$acceptCanvas, message(paste('input$acceptCanvas was changed to:', input$acceptCanvas, '\t')))
  observeEvent(input$undoCanvas, message(paste('input$undoCanvas was changed to:', input$undoCanvas, '\t')))
  observeEvent(input$clearCanvas, message(paste('input$clearCanvas was changed to:', input$clearCanvas, '\t')))
  
  observeEvent(input$nextSite, message(paste('input$nextSite was changed to:', input$nextSite, '\t')))
  observeEvent(input$previousSite, message(paste('input$previousSite was changed to:', input$previousSite, '\t')))
  
  observeEvent(input$emailROI, message(paste('input$emailROI was changed to:', input$emailROI, '\t')))
  observeEvent(input$saveROI, message(paste('input$previousSite was changed to:', input$saveROI, '\t')))
  observeEvent(input$password, message(paste('input$password was changed to: xxx', '\t')))
  
  observeEvent(input$gotoDate, message(paste('input$gotoDate was changed to:', as.character(input$gotoDate), '\t')))
  observeEvent(input$contID, message(paste('input$contID was changed to:', input$contID, '\t')))
  observeEvent(input$gotoDateButton, message(paste('input$gotoDateButton was changed to:', input$gotoDateButton, '\t')))
  
  observeEvent(input$ccRange, message(paste('input$ccRange was changed to:', input$ccRange, '\t')))
  observeEvent(input$startExtractCC, message(paste('input$startExtractCC was changed to:', input$startExtractCC, '\t')))
  observeEvent(input$ccBand, message(paste('input$ccBand was changed to:', input$ccBand, '\t')))
  
  observeEvent(input$maskEndDate, message(paste('input$maskEndDate was changed to:', as.character(input$maskEndDate), '\t')))
  observeEvent(input$maskEndTime, message(paste('input$maskEndTime was changed to:', input$maskEndTime, '\t')))
  observeEvent(input$maskName, message(paste('input$maskName was changed to:', input$maskName, '\t')))
  observeEvent(input$maskStartDate, message(paste('input$maskStartDate was changed to:', as.character(input$maskStartDate), '\t')))
  observeEvent(input$maskStartTime, message(paste('input$maskStartTime was changed to:', input$maskStartTime, '\t')))
  observeEvent(input$matchEnd, message(paste('input$matchEnd was changed to:', input$matchEnd, '\t')))
  observeEvent(input$matchStart, message(paste('input$matchStart was changed to:', input$matchStart, '\t')))
  observeEvent(input$matchStart, message(paste('input$matchStart was changed to:', input$matchStart, '\t')))
  observeEvent(input$openEnd, message(paste('input$openEnd was changed to:', input$openEnd, '\t')))
  
  observeEvent(input$errorBrowser, message(paste('input$errorBrowser was changed to:', input$errorBrowser, '\t')))
  observeEvent(input$errorDate, message(paste('input$errorDate was changed to:', as.character(input$errorDate), '\t')))
  observeEvent(input$errorEmail, message(paste('input$errorEmail was changed to:', input$errorEmail, '\t')))
  observeEvent(input$errorMessage, message(paste('input$errorMessage was changed to:', input$errorMessage, '\t')))
  observeEvent(input$errorOS, message(paste('input$errorOS was changed to:', input$errorOS, '\t')))
  observeEvent(input$errorSend, message(paste('input$errorSend was changed to:', input$errorSend, '\t')))
  observeEvent(input$errorSite, message(paste('input$errorSite was changed to:', input$errorSite, '\t')))
  observeEvent(input$errorTime, message(paste('input$errorTime was changed to:', input$errorTime, '\t')))
  observeEvent(input$errorType, message(paste('input$errorType was changed to:', input$errorType, '\t')))
  observeEvent(input$errorUser, message(paste('input$errorUser was changed to:', input$errorUser, '\t')))
  
  observeEvent(input$siteInfo, message(paste('input$siteInfo was changed to:', input$siteInfo, '\t')))
  observeEvent(input$modalSiteInfo, message(paste('input$modalSiteInfo was changed to:', input$modalSiteInfo, '\t')))

    # observeEvent(input$newPoint, message(paste('input$newPoint was changed to:', input$newPoint, '\t')))
